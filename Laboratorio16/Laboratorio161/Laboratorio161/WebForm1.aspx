...
<body>
    <form id="form1" runat="server">
        <div class="cal">
            ...
            <asp:TextBox ID="t" runat="server" Style="margin-left:50px;margin-top:24px;" Width="335px" Height="41px" OnTextChanged="t1_TextChanged"></asp:TextBox>
            ...
            <asp:Button ID="b0" runat="server" Text="0" Height="37px" Style="margin-left:0px; Width:57px" OnClick="b0_Click" />
            <asp:Button ID="clr" runat="server" Text="CLR" Height="37px" Style="margin-left:0px; Width:57px" OnClick="clr_Click" />
            <asp:Button ID="eql" runat="server" Text="=" Height="37px" Style="margin-left:0px; Width:57px" OnClick="eql_Click" />
            <asp:Button ID="div" runat="server" Text="/" Height="37px" Style="margin-left:0px; Width:57px" OnClick="div_Click" />
        </div>
    </form>
</body>
</html>
