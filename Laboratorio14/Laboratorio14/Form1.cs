    ...
    public partial class frmProductos : Form
    {
        ...
        private void tsbGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (nuevo)
            {
                ...
                string sql = "UPDATE LAPTOP SET NOMBRE='"+txtNombre.Text+ "',PRECIO='"+txtPrecio.Text+ "',STOCK='"+txtStock.Text+"' WHERE id"+txtId.Text+"";
                SqlConnection con = new SqlConnection(connectionString);
                SqlCommand cmd = new SqlCommand(sql, con);
                cmd.CommandType = CommandType.Text;
                con.Open();
        ...
        {
            if (tstId.Text == null || tstId.Text == "" || String.IsNullOrEmpty(tstId.Text) || String.IsNullOrWhiteSpace(tstId.Text))
            {
                return;
            }
